...
I'm a second year Computational Biology PhD Student at the [Tri-Institutional PhD program](https://compbio.triiprograms.org/) (Cornell University + MSK Cancer Center + Rockefeller University). I am in the [Quaid Morris Lab](https://www.morrislab.ai/) where I develop machine learning methods to better understand cancer evolution and gene regulation. I work on methods that use gradient based learning of discrete objects to learn the history of metastatis in patients' cancer evolution trees. I like developing easy to use software tools, which is incredibly important in a field that brings together scientists from various backgrounds.
